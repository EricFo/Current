...
public class PrizedrawController : MonoBehaviour
{
    ...
    public void InitBonus(int introCoinCount,int addSpinCount)
    {
        ...
        InitPrizedrawResult(introCoinCount,addSpinCount);
    ...
    private void InitPrizedrawResult(int introCoinCount,int addSpinCount)
    {
        ...
        int coinCount = /*ConfigManager.bonusConfig.BonusIntroCoinCount[GlobalObserver.CoinPosLevel.Count][index]*/introCoinCount;
        ...
        int addSpin2Count = Random.Range(1, (extraSpinCount / 2) + 1);
