...
public class BonusReelContainer : ReelContainer {
    ...
    public bool isStarFly = false;
    public bool isScore = false;
    public bool isWheelRolling = false;
    ...
    public void InitGamePlay() {
        ...
        GlobalObserver.NewSequence(string.Format("{0}--{1}--{2}", SequenceCoinCount, CoinSequence.Length, comboRand));
        CaculateWheelResult();
    }
    /// <summary>
