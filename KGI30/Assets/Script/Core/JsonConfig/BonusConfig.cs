...
public class BonusConfig {
    ...
    /// </summary>
    public float[] MultiplierValueProbability = new float[0];
    /// <summary>
    /// Multiplier玩法中乘数数值的概率
    /// </summary>
    public float[] MultiplierValueProbability_7 = new float[0];
    public int[] MultiplierValue_6 = new int[0];
    /// <summary>
    /// Multiplier玩法中乘数数值的概率
    /// </summary>
    public float[] MultiplierValueProbability_6 = new float[0];
    /// <summary>
    /// Multiplier玩法中乘数数值的概率
    /// </summary>
    public float[] MultiplierValueProbability_67 = new float[0];
    /// <summary>
    /// Multiplier玩法中需要乘数的钻石个数
    /// </summary>
    public float[] MultiplierCountProbability = new float[0];
    /// <summary>
