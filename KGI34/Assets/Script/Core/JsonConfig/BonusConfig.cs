...
public class BonusConfig
{
    ...
    /// FreeGame的游戏次数
    /// </summary>
    public int[] FreeSpinCount = new int[0];
    /// <summary>
    /// FreeGame的游戏次数概率
    /// </summary>
    public float[] FreeSpinCountProbability = new float[0];
    /// <summary>
    /// 牛头升级Wild的倍率
    /// </summary>
    public int[] UpgradeMultiplier = new int[0];
    /// <summary>
    /// 牛头升级Wild的倍率概率
    /// </summary>
    public float[][] UpgradeMultiplierProbability = new float[0][];
    /// <summary>
    /// 升级个数
    /// </summary>
    public int[] UpgradeCount = new int[0];
    /// <summary>
    /// 升级个数概率
    /// </summary>
    public float[][] UpgradeCountProbability = new float[0][];
    /// <summary>
    /// Coin概率
    /// </summary>
    ...
    /// Scatter概率
    /// </summary>
    public Dictionary<int, float> ScatterCountProbability = new Dictionary<int, float>();
    /// <summary>
    /// AddSpin概率
    /// </summary>
    public float AddSpinProbability;
    /// <summary>
    /// 中间的结果
    /// </summary>
    ...
    /// 结果序列
    /// </summary>
    public int[][] ResultSequence = new int[0][];
    /// <summary>
