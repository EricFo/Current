...
public class BaseConfig
{
    ...
    public float ResultChooseProbability;
    /// <summary>
    /// Reel最终结果Symbol选取概率
    /// </summary>
    public float[][] ResultScatterSymbolsProbability = new float[0][];
    /// <summary>
    /// Reel最终结果Symbol选取概率
    /// </summary>
    public float[][] ResultNoScatterSymbolsProbability = new float[0][];
    /// <summary>
