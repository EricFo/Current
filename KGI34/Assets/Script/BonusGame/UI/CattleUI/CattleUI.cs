...
public class CattleUI : MonoBehaviour
{
    ...
    public void PlayPurseIntro2Anim()
    {
    ...
    public IEnumerator _PlayBonusAddCattleAnim(IReelState[] reels)
    {
    ...
    {
        purseAnim.gameObject.SetActive(true);
        ResetCattle();
    ...
    {
        //purseAnim.gameObject.SetActive(false);
        isBigCattle = false;
        PlayCattleLoopAnim();
        //cattleAnim.transform.position = cattlePos[2];
    }
