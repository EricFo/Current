...
public class BonusCoinSymbol : CoinSymbol
{
    ...
    public override int Level
    {
        ...
        {
            level = value;
            //MainTex.sprite = coinSpriteByJackPot[value - 1];
    ...
    protected int MINISTOP = Animator.StringToHash("MiniStop");
    protected int MINORSTOP = Animator.StringToHash("MinorStop");
    protected int MAJORSTOP = Animator.StringToHash("MajorStop");
    protected int GRANDSTOP = Animator.StringToHash("GrandStop");
    #endregion
    ...
    {
        SetSortingOrder(DefaultSortingOrder + (isUpgrade ? 200 : 0));
    }
    ...
    public override void PlayStopAnim()
    {
        ...
        {
            case JackpotType.Mini:
                PlayAnimation(MINISTOP);
                break;
            case JackpotType.Minor:
                PlayAnimation(MINORSTOP);
                break;
            case JackpotType.Major:
                PlayAnimation(MAJORSTOP);
                break;
            case JackpotType.Grand:
                PlayAnimation(GRANDSTOP);
                break;
        }
    }
    ...
    public override void SetScore(JackpotType jackpot)
    {
        base.SetScore(jackpot);
        ScoreValue = (int)(GlobalObserver.Meters[3 - GlobalObserver.JackpotIDDic[jackpot]] * 100);
    }
