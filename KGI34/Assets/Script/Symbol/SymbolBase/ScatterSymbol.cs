...
public class ScatterSymbol : CommonSymbol
{
    ...
    protected int UPGRADEHIT1 = Animator.StringToHash("UpgradeHit1");
    protected int UPGRADEHIT2 = Animator.StringToHash("UpgradeHit2");
    protected int UPGRADEHIT3 = Animator.StringToHash("UpgradeHit3");
    #endregion
    ...
    public void SetLongFireDisplay(bool isDisplay)
    {
        fire2.gameObject.SetActive(isDisplay);
    }
    ...
    public void PlayBonusUpgradeAnim(bool isDisplay)
    {
        if (isDisplay)
        {
            AudioManager.Playback("FE_SpecialActive Bonus（bonus）");
            AudioManager.Playback("FE_SpecialActiveMAppear");
            SetSortingOrder(DefaultSortingOrder + 400);
            PlayAnimation(UPGRADEHIT1);
        }
        else
        {
            PlayAnimation(UPGRADEHIT3);
        }
    }
