...
namespace SlotGame.Core {
    public static class GlobalObserver {
        ...
        /// 是否有加分玩法
        /// </summary>
        public static bool IsUpgradePlay { get; set; }
        /// <summary>
        /// 是否有收集玩法
        /// </summary>
        public static bool IsCollectPlay { get; set; }
        /// <summary>
        /// 是否触发JackPot
        /// </summary>
        ...
        /// Free模式中赔付是否完成
        /// </summary>
        public static bool DonePayout { get; set; }
        /// <summary>
        /// 转轮的Win动画是否播够时长
        /// </summary>
        public static bool DoneWinAnim { get; set; }
        /// <summary>
        ...
        /// 当前Bonus模式，1，2，3
        /// </summary>
        public static int CurrentBonusState { get; set; }
        /// <summary>
        /// 本轮可变Symbol要变的Symbol种类
        /// </summary>
        public static string VarSymbolName { get; set; }
        /// <summary>
        /// Freegame赔付倍率
        /// </summary>
        public static int PayMultiplier { get; set; }
        /// <summary>
        /// 所有玩法的结果集合
        /// </summary>
        private static Dictionary<GameState, PayoutInfo> Results;
        public static Dictionary<int, string> BonusMusic = new Dictionary<int, string>()
        {
        {1,"KGI-Game29-Bonus-Music1" },
        {2,"KGI-Game29-Bonus-Music2" },
        {3,"KGI-Game29-Bonus-Music3" }
        };
        #endregion
        ...
        /// 获取到新序列时的监听事件
        /// </summary>
        public static event Action<string> OnNewSequenceEvent;
        /// <summary>
        /// 切换Bet时的监听事件
        /// </summary>
        ...
        public static void NewSequence(string info)
        {
            OnNewSequenceEvent?.Invoke(info);
        }
        /// <summary>
        /// 设置游戏AutoPlay状态
        /// </summary>
            ...
            if (OnEvaluateEvents.ContainsKey(mode)) {
                ...
                foreach (var item in info.ResultNodes) {
                    if (OnEvaluateEvents[mode] != null) {
                        ...
                        if (CurrGameState.Equals(GameState.Bonus))
                        {
                            info.WinMoney *= PayMultiplier;
                        }
                    }
                }
                UpdateWin(info);
